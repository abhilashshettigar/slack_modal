...
app.action("open_modal", async ({ ack, context, action, body }) => {
  ...
  //console.log(body) //spencer edits
  //console.log(context)
...
app.view("forecast-modal-identifier", async ({ ack, body, context }) => {
  ack();
  console.log(body.view.state.values); //spencer edits
  console.log(context) //spencer edits
});
...
app.view(/w*/, async ({ ack, body, context }) => {
  ack();
  //console.log(body) //spencer edits
  //console.log(context) //spencer edits
});
...
(async () => {
  ...
  console.log(
    "Your URL: https://" + process.env.PROJECT_NAME + ".glitch.me/slack/events"
  );
})();
